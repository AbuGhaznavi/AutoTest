...
namespace AutoTest
{
    public partial class MetronodeLTPortsForm : Form
    {
        ...
        {
            if (mainForm.switchChoice == null)
            {
                MessageBox.Show("No switch selected");
                return;
            }

            if (mainForm.switchChoice.Equals("A") || mainForm.switchChoice.Equals("B"))
            {
                checkBox1.Checked = true;
                checkBox2.Checked = true;
            } else if (mainForm.switchChoice.Equals("C"))
            {
                checkBox1.Checked = true;
                checkBox2.Checked = true;
        ...
        private void uncheck_all_btn_Click(object sender, EventArgs e)
        {
            if (mainForm.switchChoice == null)
            {
                MessageBox.Show("No switch selected");
